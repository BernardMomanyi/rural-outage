...
<head>
  ...
  <title>Contact Messages - OutageSys Admin</title>
  ...
  <div class="admin-bg">
    <div class="container" style="width:100%;">
      <div class="card mb-md">
        <h2 class="h2 mb-sm"><i class="fa fa-envelope"></i> Contact Messages</h2>
        <p class="mb-md">View and manage contact messages submitted by users.</p>
        <div class="text-center mt-md">
          <span class="small" style="color:var(--color-secondary);">No messages to display yet.</span>
        </div>
      </div>
